...
const Footer = () => {
  ...
  const menuImages: Record<string, any> = {
    ALL: require('../../../assets/ALL.webp'),
    SLOT: require('../../../assets/SLOT.webp'),
    KENO: require('../../../assets/KENO.webp'),
  ...
  const resSize = (percentage: number) =>
    (percentage / 100) * Math.min(width, height); // Scales uniformly

  return (
    <View style={[styles.footerWrapper, { height: resHeight(14) }]}>
      {/* Left Coin GIF */}
      <Image
        source={require('../../../assets/fotter-coin.gif')}
        style={[
          styles.coinGif,
          {
            width: resSize(38),
      ...
      <ImageBackground
        source={require('../../../assets/footer-bg.webp')}
