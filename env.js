 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.com.underpin.dingding.staging
 */
...
const NAME = 'com.underpin.dingding'; // app name
const EXPO_ACCOUNT_OWNER = 'dev-rohit'; // expo account owner
